...
asn1_tlv::asn1_tlv(const unsigned char* buf, unsigned int len, vector<asn1_tlv* >& brothers)
{
	...
	if(parsed_len < len)
	{
		asn1_tlv* asn1_one  = new asn1_tlv(m_buf + parsed_len, len - parsed_len, brothers);
