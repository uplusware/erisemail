...
unsigned int CMailBase::m_encryptxmpp =
    XMPP_TLS_OPTIONAL; /* 0: Non-encrypted or TLS optional; 1: TLS required; 2:
                          Old-SSL-based */
...
string CMailBase::m_ldap_search_filter_user =
...
string CMailBase::m_ldap_search_filter_group =
...
void CMailBase::SetConfigFile(const char* config_file,
  ...
  while (getline(configfilein, strline)) {
    ...
    if (strncasecmp(strline.c_str(), "#", 1) != 0) {
      ...
      if (strcasecmp(strKey.c_str(), "Encoding") == 0) {
        ...
        m_smtp_client_trace =
            (strcasecmp(smtp_client_trace.c_str(), "yes")) == 0 ? TRUE : FALSE;
      }
#ifdef _WITH_HDFS_
        ...
        strtrim(enable_smtp);
        m_enablesmtp =
            (strcasecmp(enable_smtp.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_enablepop3tls =
            (strcasecmp(EnablePOP3TLS.c_str(), "yes")) == 0 ? TRUE : FALSE;
      } else if (strcasecmp(strKey.c_str(), "IMAPEnable") == 0) {
        string IMAPEnable;
        strcut(strline.c_str(), "=", NULL, IMAPEnable);
        strtrim(IMAPEnable);
        m_enableimap =
            (strcasecmp(IMAPEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_enableimaptls =
            (strcasecmp(EnableIMAPTLS.c_str(), "yes")) == 0 ? TRUE : FALSE;
      } else if (strcasecmp(strKey.c_str(), "SMTPSEnable") == 0) {
        string SMTPSEnable;
        strcut(strline.c_str(), "=", NULL, SMTPSEnable);
        strtrim(SMTPSEnable);
        m_enablesmtps =
            (strcasecmp(SMTPSEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        strtrim(POP3SEnable);
        m_enablepop3s =
            (strcasecmp(POP3SEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        strtrim(IMAPSEnable);
        m_enableimaps =
            (strcasecmp(IMAPSEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        strtrim(XMPPEnable);
        m_enablexmpp =
            (strcasecmp(XMPPEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_enablexmppfederation =
            (strcasecmp(XMPPFederationEnable.c_str(), "yes")) == 0 ? TRUE
                                                                   : FALSE;
        ...
        strtrim(LDAPEnable);
        m_enable_local_ldap =
            (strcasecmp(LDAPEnable.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_encrypt_local_ldap =
            (strcasecmp(encryptldap.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_ca_verify_client =
            (strcasecmp(ca_verify_client.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        strtrim(is_master);
        m_is_master =
            (strcasecmp(is_master.c_str(), "yes")) == 0 ? TRUE : FALSE;
      ...
      } else if (strcasecmp(strKey.c_str(), "LDAPSearchAttribute_User_ID") ==
                 0) {
        strcut(strline.c_str(), "=", NULL, m_ldap_search_attribute_user_id);
        strtrim(m_ldap_search_attribute_user_id);
      } else if (strcasecmp(strKey.c_str(),
                            "LDAPSearchAttribute_User_Password") == 0) {
        strcut(strline.c_str(), "=", NULL,
               m_ldap_search_attribute_user_password);
        strtrim(m_ldap_search_attribute_user_password);
      } else if (strcasecmp(strKey.c_str(), "LDAPSearchAttribute_User_Alias") ==
                 0) {
        ...
        strtrim(m_ldap_search_filter_group);
                            ...
                            "LDAPSearchAttribute_Group_Memeber") == 0) {
        strcut(strline.c_str(), "=", NULL,
               m_ldap_search_attribute_group_member);
        ...
        strtrim(enable_mta);
        m_enablemta =
            (strcasecmp(enable_mta.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_enablesmtphostnamecheck =
            (strcasecmp(SMTPHostNameCheck.c_str(), "yes")) == 0 ? TRUE : FALSE;
        ...
        m_memcached_list.insert(
            std::pair<string, int>(memc_addr.c_str(), memc_port));
      }
      /* else
      {
              printf("%s\n", strline.c_str());
