/*
        ...
        uplusware@gmail.com
*/
#ifndef _XMPP_SESSIONS_H_
#define _XMPP_SESSIONS_H_
    ...
    if (m_st == stXMPP)
      m_protocol =
          new CXmpp(this, m_epoll_fd, m_sockfd, m_ssl, m_ssl_ctx,
                    m_clientip.c_str(), m_client_port, m_storage_engine,
                    m_memcached, m_isSSL, m_is_client_role,
                    m_peer_domainname.c_str(), m_isXmppDialBack, m_dependency);
    else
      m_protocol = NULL;
