...
BOOL Session_Group::Connect(const char* hostname, unsigned short port, Service_Type st, StorageEngine* storage_engine, memory_cache* ch, memcached_st * memcached, std::stack<string>& data_stack, BOOL isXmppDialBack)
{
    char szPort[16];
