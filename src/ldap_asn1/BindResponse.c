...
static asn_TYPE_member_t asn_MBR_BindResponse_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BindResponse, errorMessage),
		(ASN_TAG_CLASS_UNIVERSAL | (4 << 2)),
		0,
...
static ber_tlv_tag_t asn_DEF_BindResponse_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BindResponse_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 1, 0, 1 }, /* matchedDN at 208 */
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, -1, 0 }, /* errorMessage at 209 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* resultCode at 174 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* referral at 210 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 4, 0, 0 } /* serverSaslCreds at 213 */
};
static asn_SEQUENCE_specifics_t asn_SPC_BindResponse_specs_1 = {
	sizeof(struct BindResponse),
	offsetof(struct BindResponse, _asn_ctx),
	asn_MAP_BindResponse_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_BindResponse = {
	...
	sizeof(asn_DEF_BindResponse_tags_1)
		/sizeof(asn_DEF_BindResponse_tags_1[0]) - 1, /* 1 */
