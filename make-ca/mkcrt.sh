...
openssl req -new -key private/cakey.pem -out private/ca.csr -subj "/C=CN/ST=BJ/L=BJ/O=uplusware/OU=uplusware/CN=localhost"
...
openssl req -new -key private/server-key.pem -out private/server.csr -subj "/C=CN/ST=BJ/L=BJ/O=uplusware/OU=uplusware/CN=localhost"
...
openssl req -new -key private/client-key.pem -out private/client.csr -subj "/C=CN/ST=BJ/L=BJ/O=uplusware/OU=uplusware/CN=localhost"
