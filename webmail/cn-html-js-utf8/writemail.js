...
function init() {
    ...
    $id('GLOBALPATH').innerHTML = (Request.QueryString('GPATH') == null ? ("/草稿箱") : decodeURIComponent(Request.QueryString('GPATH')));
...
function do_savesent() {
    ...
    xmlHttp.onreadystatechange = function () {
        if (xmlHttp.readyState == 4) {
                ...
                if (responseNode.tagName == "response") {
                    var errno = responseNode.getAttribute("errno")
                        if (errno == "0" || errno == 0) {
                            ...
                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "保存邮件到已发送邮件文件夹成功";
                            ...
                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "<font color='#FF0000'>保存邮件到已发送邮件文件夹失败</font>";
                            $("#PROCESSING_DIV").dialog();
                        }
                }
            } else {
            ...
            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "正在保存邮件到发件箱 - <img src=\"waiting.gif\" />";
            $("#PROCESSING_DIV").dialog();
        }
    }
                ...
                if (responseNode.tagName == "response") {
                    var errno = responseNode.getAttribute("errno")
                        if (errno == "0") {
                            isChange = false;
                            toggle_onbeforeunload(isChange);
                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "发送邮件成功";
                            $("#PROCESSING_DIV").dialog();

                            do_savesent();
                        } else {
                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "<font color='#FF0000'>发送邮件失败(邮件太大)</font>";
                            $("#PROCESSING_DIV").dialog();
                        }
                }
            } else {
                $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "<font color='#FF0000'>发送邮件失败</font>";
                $("#PROCESSING_DIV").dialog();
            }
        } else {
            sending_status = true;
            toggle_onbeforeunload(sending_status);
            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "正在发送邮件 - <img src=\"waiting.gif\" />";
            $("#PROCESSING_DIV").dialog();
        }
    }
    xmlHttp.open("POST", qUrl, true);
    ...
    xmlHttp.onreadystatechange = function () {
        if (xmlHttp.readyState == 4) {
            ...
            if (xmlHttp.status == 200) {
                ...
                if (responseNode.tagName == "response") {
                    var errno = responseNode.getAttribute("errno")
                        if (errno == "0") {
                            ...
                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "保存草稿成功";
                            $("#PROCESSING_DIV").dialog();

                        } else {

                            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "<font color='#FF0000'>保存草稿出错(邮件太大)</font>";
                            $("#PROCESSING_DIV").dialog();
                ...
                $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "<font color='#FF0000'>保存草稿出错</font>";
                $("#PROCESSING_DIV").dialog();
            ...
            saving_status = true;
            toggle_onbeforeunload(saving_status);
            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "正在保存草稿 - <img src=\"waiting.gif\" />";
            $("#PROCESSING_DIV").dialog();
        }
    }
...
function do_copy_mail(mid, todirs) {
    ...
    xmlHttp.onreadystatechange = function () {
        ...
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "正在复制，请等待...";
            $("#PROCESSING_DIV").dialog();
        }
    }
    xmlHttp.open("GET", qUrl, true);
...
function do_move_mail(mid, todirs) {
    ...
    xmlHttp.onreadystatechange = function () {
        ...
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            $id('PROCESSING_TBL').rows[0].cells[0].innerHTML = "正在移动，请等待...";
            $("#PROCESSING_DIV").dialog();
        }
