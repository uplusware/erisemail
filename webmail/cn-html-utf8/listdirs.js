                        ...
                        if (errno == "0" || errno == 0) {
                            ...
                            for (var i = 0; i < countList.length; i++) {
                                if (countList.item(i).tagName == "count") {
                                    tdobj.innerHTML = countList.item(i).childNodes[0] == null ? "0" : countList.item(i).childNodes[0].nodeValue + " 封";
...
function output_dir(tblobj, pid, path, nodeObj, layer) {
    ...
    for (var i = 0; i < nodeObj.length; i++) {
        ...
        if (nodeObj.item(i).tagName == "dir") {
            ...
            td2.innerHTML = "<img src=\"append.gif\" alt=\"创建文件夹\">";
            ...
            if (isCommon) {
                td3.innerHTML = "<img src=\"delete.gif\" alt=\"删除文件夹\">";

                td3.onclick = function () {
                    if (confirm("确实要删除此文件夹吗?") == true)
            ...
            if (responseNode.tagName == "response") {
                var errno = responseNode.getAttribute("errno")
                    if (errno == "0" || errno == 0) {
                        ...
                        _$_('LOGIN_USERNAME').innerHTML = "<font color=\"#FFFFFF\"><b>[" + strTmp + "]</b>的文件夹</font>";
                    }
            }
        }
    }
