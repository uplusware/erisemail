...
cp ca/erise-root.crt $3-erisemail-bin-cn-$2-${m}-${o}/erise-root.crt
cp ca/erise-server.crt $3-erisemail-bin-cn-$2-${m}-${o}/erise-server.crt
cp ca/erise-server.key $3-erisemail-bin-cn-$2-${m}-${o}/erise-server.key

cp ca/erise-client.crt $3-erisemail-bin-cn-$2-${m}-${o}/erise-client.crt
cp ca/erise-client.key $3-erisemail-bin-cn-$2-${m}-${o}/erise-client.key
